package com.morcineck.usuario.business;

import com.morcineck.usuario.business.converter.UsuarioConverter;
...
import com.morcineck.usuario.infrastructure.entity.Telefone;
...
public class UsuarioService {
    ...
    public UsuarioDTO atualizaDadosUsuario(String token, UsuarioDTO dto) {
        //Aqui buscamos email do usuário através do token (tira a obrigatoriedade do email)
